...
const Expenses = () => {
    ...
    const [form, setForm] = useState({ id_personne: '', categorie: '', montant: '', date: '', mode: 'Espèces', description: '' });
        ...
        <div>
            ...
            {showModal && (
                <div className="modal-overlay" style={modalOverlayStyle}>
                    <form onSubmit={handleAdd} className="modal-content" style={modalContentStyle}>
                        ...
                        <input style={inputStyle} placeholder="Catégorie (ex: Loyer)" value={form.categorie} onChange={e => setForm({...form, categorie: e.target.value})} required />
